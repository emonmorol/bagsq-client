      ...
      <div className="lg:w-[60ch] px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
          ...
          <div className="strength-option shadow hover:shadow-lg transition-all duration-300">
            ...
            <p className="text-xs leading-4">
              Easily customise your invoice according to your customers pricing
              levels.
            </p>
          </div>
          ...
          <div className="strength-option shadow hover:shadow-lg transition-all duration-300">
            ...
            <p className="text-xs leading-4">
              Workshop Mate is supported, owned and operated in Australia. Call
              or email us when you need support
            </p>
          </div>
          ...
          <div className="strength-option shadow hover:shadow-lg transition-all duration-300">
            ...
            <p className="text-xs leading-4">
              Just at a simple click Service History lets you know the customer
              name and vehicle history
            </p>
          </div>
        </div>
      </div>
