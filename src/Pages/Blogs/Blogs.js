      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-7 px-4 lg:px-20">
        <div className="question-container bg-white px-5 lg:px-10 py-6 lg:py-16 rounded-xl shadow hover:shadow-xl">
          ...
          <p className="lg:text-base text-sm">
            ...
            libraries. Javascript is mainly used for client side activity for a
            web application it provides dynamic changes in web application.
        ...
        <div className="question-container bg-white px-5 lg:px-10 py-6 lg:py-16 rounded-xl shadow hover:shadow-xl">
          ...
          <p className="lg:text-base text-sm">
            NodeJs is and asynchronous event driven JavaScript Runtime. When we
            run stand alone code at that kind of code we can use NodeJs and also
            when we create server site for any project at that time use use
            nodeJS <br />
            ...
            etc. this is where mongodb comes is . mongoDB gives us to create api
            and to store data update it delete it. and when we need to do this
            type of work , than we use mongoDB.
          </p>
        </div>
        <div className="question-container bg-white px-5 lg:px-10 py-6 lg:py-16 rounded-xl shadow hover:shadow-xl">
          <div className="flex items-center">
          ...
          <p className="lg:text-base text-sm">
            ...
            and best for complex queries and this database are not suitable for
            hierarchical data storage whereas NoSQL is horizontally scalable and
            not good for complex queries and best suited for hierarchical data
            storage.
          </p>
        </div>
        <div className="question-container bg-white px-5 lg:px-10 py-6 lg:py-16 rounded-xl shadow hover:shadow-xl">
          ...
          <p className="lg:text-base text-sm">
            ...
            authentication/authorization mechanism.Most Of the time We use it to
            authorize user and to protect api's.It shares security information
            between client site and server site. <br />
